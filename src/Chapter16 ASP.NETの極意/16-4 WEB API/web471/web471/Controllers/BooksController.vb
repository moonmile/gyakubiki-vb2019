    ...
    Public Class BooksController
        ...
        Public Sub New()
            _lst = New List(Of Book)({
                New Book With {.ID = 1, .Title = "逆引き大全VB", .Price = 1000, .Pages = 300},
                New Book With {.ID = 2, .Title = "逆引き大全C#", .Price = 2000, .Pages = 300},
                New Book With {.ID = 3, .Title = "逆引き大全F#", .Price = 3000, .Pages = 300},
                New Book With {.ID = 4, .Title = "リファレンス本", .Price = 5000, .Pages = 300}
            })
        End Sub
