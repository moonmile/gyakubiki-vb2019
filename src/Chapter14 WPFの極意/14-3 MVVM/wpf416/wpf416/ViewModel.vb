...
Public Class ViewModel
    ...
    Private _CommitCommand As Command
    Public ReadOnly Property CommitCommand As Command
        Get
            If _CommitCommand Is Nothing Then
                _CommitCommand = New Command(
                    Sub()
                        Message = $"{Name} さん、登録をありがとうございます"
                    End Sub)
            End If
    ...
    Public Class Command
        ...
        Public Function CanExecute(parameter As Object) As Boolean Implements ICommand.CanExecute
            Return Me._action IsNot Nothing
        End Function
